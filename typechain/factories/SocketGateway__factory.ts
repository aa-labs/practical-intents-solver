...
import type { SocketGateway, SocketGatewayInterface } from "../SocketGateway";
...
export class SocketGateway__factory {
  static readonly abi = _abi;
  static createInterface(): SocketGatewayInterface {
    return new utils.Interface(_abi) as SocketGatewayInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SocketGateway {
    return new Contract(address, _abi, signerOrProvider) as SocketGateway;
  }
}
